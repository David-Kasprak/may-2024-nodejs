...
const foo = async () => {
    // Creating "baseFolder" folder
    const pathToFile = path.join(__dirname, 'baseFolder');
    await fs.mkdir(pathToFile, {recursive: true});
    //Creating additional folders inside the "baseFolder" + creating files for each folder from the array
    ...
    // Reading and Checking the data type (folder - true/false, file - true/false)
